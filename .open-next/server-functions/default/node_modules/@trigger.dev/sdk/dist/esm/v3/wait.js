...
import { accessoryAttributes, apiClientManager, flattenAttributes, ManualWaitpointPromise, mergeRequestOptions, runtime, SemanticInternalAttributes, taskContext, WaitpointTimeoutError, } from "@trigger.dev/core/v3";
...
async function retrieveToken(token, requestOptions) {
    ...
    const data = result.output
        ? await conditionallyImportAndParsePacket({ data: result.output, dataType: result.outputType ?? "application/json" }, apiClient)
        : undefined;
    let error = undefined;
